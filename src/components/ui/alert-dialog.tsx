...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    className={cn(
      "fixed inset-0 z-50 bg-black/80  data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=fade-out-0]:fade-out-0 data-[state=fade-in-0]:fade-in-0",
      className
    )}
    {...props}
    ref={ref}
