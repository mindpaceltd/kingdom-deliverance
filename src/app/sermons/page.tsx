  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="py-28 bg-primary text-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1544427920-c49ccfb85579?q=80&w=2000&auto=format&fit=crop')" }} />
        <div className="container relative z-10 text-center px-4">
          ...
          <h1 className="font-serif text-5xl md:text-6xl font-bold">Sermons & Messages</h1>
